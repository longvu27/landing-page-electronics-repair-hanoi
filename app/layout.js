...
export const metadata = {
  ...
  title: "Sửa điện nước tại nhà Hà Nội — Chuyên nghiệp, uy tín",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Sửa điện nước tại nhà Hà Nội — Chuyên nghiệp, uy tín",
      },
    ],
  },
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "@type": "LocalBusiness",
              "name": "Sửa điện nước tại nhà Hà Nội — Chuyên nghiệp, uy tín",
              "address": {
                "@type": "PostalAddress",
