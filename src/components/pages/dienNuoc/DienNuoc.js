...
export default function DienNuoc() {
  ...
  return (
    <div className={s.wrapper}>
      ...
      <ul>
        <li>Phục vụ tận nơi nhanh chóng tại tất cả các khu vực Hà Nội</li>
