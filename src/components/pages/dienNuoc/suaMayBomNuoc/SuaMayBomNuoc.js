...
export default function SuaMayBomNuoc() {
  ...
  return (
    <div className={s.wrapper}>
      ...
      <p>Nếu có bất kỳ vấn đề gì về các thiết bị điện nước trong gia đình bạn, hãy gọi cho chúng tôi theo Hotline: <span><a href="tel:0964701333" onClick={trackingCallNow}>0964 701 333</a></span> hoặc <span><a onClick={trackingCallNow} href="tel:0866885445">0866 885 445</a></span> bất kể khi nào bạn cần. Hoặc nhấn vào nút gọi / chat zalo ngay trên trang web</p>
