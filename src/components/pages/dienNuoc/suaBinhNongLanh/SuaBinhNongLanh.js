...
export default function SuaBinhNongLanh() {
  ...
  return (
    <div className={s.wrapper}>
      ...
      <p>Liên hệ ngay với <span>Doãn Anh</span> qua hotline <span><a href="tel:0964701333" onClick={trackingCallNow}>0964 701 333</a></span> hoặc <span><a onClick={trackingCallNow} href="tel:0866885445">0866 885 445</a></span> để đặt lịch hẹn sửa chữa máy lọc nước tại Hà Nội ngay hôm nay. Rất hân hạnh được phục vụ quý khách.</p>
    </div>
  )
}