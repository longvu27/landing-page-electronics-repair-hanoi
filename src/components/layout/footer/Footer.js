      ...
      <div className={`width-container ${s.container}`}>
        <div className={s.item}>
          ...
          <div className={s.text}>
            ...
            <p>Dịch vụ sửa chữa điện nước tại Hà Nội – Chuyên sửa chữa, lắp đặt điện dân dụng và các thiết bị điện nước nhanh chóng, uy tín. Hỗ trợ 24/7, có mặt sau 30 phút, cam kết giá cả minh bạch.</p>
          </div>
